...
# that a script resizes the filesystem at boot time.
{
  ...
  remove_kernel_dup = lib.optionalString (!config.infra.microvm.enabled or false) ''
    # Remove kernel image, initrd and dtb duplicates/junk from store as they are not going to be used
