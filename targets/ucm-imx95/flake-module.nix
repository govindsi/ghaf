...
#
# UCM-iMX95 Evaluation Kit platform
{
  self,
  lib,
  inputs,
...
let
      ...
      hostConfiguration = lib.nixosSystem {
        ...
        modules = [
          ...
          self.nixosModules.profiles
          {
            ...
            hardware.deviceTree.name = lib.mkForce "compulab/ucm-imx95.dtb";
  ...
  releaseModules = [ ];
  targets = [
    (ucm-imx95 "debug" debugModules)
    (ucm-imx95 "release" releaseModules)
  ];
